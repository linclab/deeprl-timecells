...
if load_time_ramp_results:
    if separate_trial_types:
        ...
        trial_reliability_results = np.load(os.path.join(save_dir,f'{seed}_{n_shuffle}_{percentile}_{epi}_trial_reliability_results_separate.npz'), allow_pickle=True)
