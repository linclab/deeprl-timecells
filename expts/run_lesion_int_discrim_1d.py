...
if __name__ == '__main__':
    ...
    parser.add_argument("--lesion_side", type=str, default='total', help="Which side to lesion. Options: 'total', 'stimulus_1', 'stimulus_2'")
    ...
    # Load_model_path: lstm_128_1e-05/seed_1_epi149999.pt, relative to training/timing
    ...
    main_dir = f'/network/scratch/l/lindongy/timecell/figures/lesion/timing1d'
