...
if __name__ == '__main__':
    ...
    if argsdict["expt_type"] == "rehydration":
        ...
        fig.suptitle(f'{env_title}_{ckpt_name}')
        ax3.plot(n_lesion, np.mean(mean_kl_div_array[0, :, :], axis=-1), color='gray', label='Random silencing')
        ...
        ax3.plot(n_lesion, np.mean(mean_kl_div_array[1, :, :], axis=-1), color='royalblue', label='Ramping cell silencing')
        ax3.fill_between(n_lesion,
        ...
        ax3.plot(n_lesion, np.mean(mean_kl_div_array[2, :, :], axis=-1), color='magenta', label='Time cell silencing')
        ax3.fill_between(n_lesion,
        ...
        ax3.set_xlabel('Number of neurons silenced')
