...
if __name__ == '__main__':
    ...
    ax2.plot(n_lesion, np.mean(postlesion_nav_array[0, :, :], axis=-1), color='gray', label=f'Random {"lesion" if argsdict["expt_type"] == "lesion" else "silencing"}')
    ...
    ax2.plot(n_lesion, np.mean(postlesion_nav_array[1, :, :], axis=-1), color='royalblue', label=f'Ramping cell {"lesion" if argsdict["expt_type"] == "lesion" else "silencing"}')
    ax2.fill_between(n_lesion,
    ...
    ax2.plot(n_lesion, np.mean(postlesion_nav_array[2, :, :], axis=-1), color='magenta', label=f'Time cell {"lesion" if argsdict["expt_type"] == "lesion" else "silencing"}')
    ax2.fill_between(n_lesion,
    ...
    if argsdict["expt_type"] == "rehydration":
        ...
        fig.suptitle(f'{env_title}_{ckpt_name}')
        ax3.plot(n_lesion, np.mean(mean_kl_div_array[0, :, :], axis=-1), color='gray', label=f'Random {"lesion" if argsdict["expt_type"] == "lesion" else "silencing"}')
        ...
        ax3.plot(n_lesion, np.mean(mean_kl_div_array[1, :, :], axis=-1), color='royalblue', label=f'Ramping cell {"lesion" if argsdict["expt_type"] == "lesion" else "silencing"}')
        ax3.fill_between(n_lesion,
        ...
        ax3.plot(n_lesion, np.mean(mean_kl_div_array[2, :, :], axis=-1), color='magenta', label=f'Time cell {"lesion" if argsdict["expt_type"] == "lesion" else "silencing"}')
        ax3.fill_between(n_lesion,
        ...
        ax3.set_xlabel(f'Number of neurons {"lesioned" if argsdict["expt_type"] == "lesion" else "silenced"}')
