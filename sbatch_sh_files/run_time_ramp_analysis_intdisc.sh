#!/bin/bash
#SBATCH --array=0-87
#SBATCH --job-name=timing1d_time_ramp
#SBATCH --output=/network/scratch/l/lindongy/timecell/sbatch_out/timing/time_ramp-%A.%a.out
#SBATCH --error=/network/scratch/l/lindongy/timecell/sbatch_err/timing/time_ramp-%A.%a.err
...
python analysis/time_ramp_ident_int_discrim_1d.py --main_dir /home/mila/l/lindongy/linclab_folder/linclab_users/deeprl-timecell/data/timing1d --data_dir $data_dir --main_save_dir /home/mila/l/lindongy/linclab_folder/linclab_users/deeprl-timecell/analysis_results/timing1d --seed $seed --episode 149999 --n_shuffle 100 --percentile 99.999
