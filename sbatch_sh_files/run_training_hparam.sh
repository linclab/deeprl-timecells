...
#SBATCH --output=/network/scratch/l/lindongy/timecell/sbatch_out/tunl2d/slurm-%A.%a.out
#SBATCH --error=/network/scratch/l/lindongy/timecell/sbatch_err/tunl2d/slurm-%A.%a.err
...
len_delay_arr=(40)
env_type_arr=('mem' 'nomem')
hidden_type_arr=('lstm' 'linear')
lr_arr=(0.000005 0.00001 0.00005)
