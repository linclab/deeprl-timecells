...
#SBATCH --job-name=tunl1d_gamma1_hparam
#SBATCH --output=/network/scratch/l/lindongy/timecell/sbatch_out/tunl1d_gamma1/slurm-%A.%a.out
#SBATCH --error=/network/scratch/l/lindongy/timecell/sbatch_err/tunl1d_gamma1/slurm-%A.%a.err
